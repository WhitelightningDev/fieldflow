...
export default function RepairHistory() {
  ...
  const rows = React.useMemo(() => {
    return filtered.map((j) => {
      ...
      const isCb = isCallback(j);
      return { j, customer, site, tech, inv, revenue, updatedLabel, isCb };
    });
  }, [customersById, filtered, invoicesByJobId, isCallback, sitesById, techsById]);
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-xl border bg-card/70 backdrop-blur-sm overflow-hidden">
        ...
        <div className="sm:hidden p-3 space-y-3">
          ...
          {rows.map(({ j, customer, site, tech, inv, revenue, updatedLabel, isCb }) => (
