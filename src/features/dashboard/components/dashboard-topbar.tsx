...
export default function DashboardTopbar({ onOpenCompliance }: { onOpenCompliance?: () => void }) {
  ...
  return (
    <div className="sticky top-0 z-30 border-b border-border/30 bg-card/80 backdrop-blur-xl pt-[max(env(safe-area-inset-top),0px)]">
      <div className="flex items-center gap-2 sm:gap-3 px-3 sm:px-4 h-14 sm:h-14">
